...
- Spring Boot JPA 프로젝트 개발 계속
	1. 스프링 시큐리티 계속
		...
		- /entitiy/Member.java role 변수 추가
...
- Spring Boot JPA 프로젝트 개발 계속
	...
	1. 비밀번호 초기화(계속)
		...
		- /service/MailService.java에 메일전송 메서드 생성, 수정
			...
			<img src="https://raw.githubusercontent.com/hugoMGSung/basic-springboot-2024/main/images/sp013.png" width="730">
		...
		- /service/MemberService.java에 setMember() 메서드 추가
			...
			<img src="https://raw.githubusercontent.com/hugoMGSung/basic-springboot-2024/main/images/sp014.png" width="730">
...
- 리액트 기초공부
	...
	2. /component/CustomButton.js 생성, 위 소스를 옮김
		...
		- 가져와 쓰기 위해서 export default 객채이름; 필수
